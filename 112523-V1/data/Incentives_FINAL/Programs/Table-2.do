...
log using "C:\Incentives_Matter_Data\Incentives_FINAL\Log Files\Table2.log", replace;
...
outreg treat using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\table2.csv", bdec(2) se 3aster rdec(2) comma bracket replace;

regress open treat if time<9, cluster(schid);
outreg treat using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\table2.csv", bdec(2) se 3aster rdec(2) comma bracket append;
