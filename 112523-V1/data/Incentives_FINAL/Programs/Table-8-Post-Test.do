...
#delimit;
capture log close;
log using "C:\Incentives_Matter_Data\Incentives_FINAL\Log Files\Table8PostTest.log", replace;
...
outreg treat using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\TABLE8PANELACOL6.csv", bdec(2) se 3aster rdec(2) comma bracket replace;
...
outreg treat_missing using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\TABLE8PANELACOL6.csv", bdec(2) se 3aster rdec(2) comma bracket append;
...
outreg treat using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\TABLE8PANELBCOL6.csv", bdec(2) se 3aster rdec(2) comma bracket replace;

regress z_add_post_math treat, cluster(schid);
outreg treat using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\TABLE8PANELBCOL6.csv", bdec(2) se 3aster rdec(2) comma bracket append;
