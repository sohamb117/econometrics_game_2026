...
log using "C:\Incentives_Matter_Data\Incentives_FINAL\Log Files\Table9_Post.log", replace;
...
outreg treat using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\Table9A_post.csv", bdec(2) nocons se 3aster rdec(2) comma bracket replace;

regress z_add_post_math treat pre_math_v pre_math_w pre_writ, cluster(schid);
outreg treat using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\Table9A_post.csv", bdec(2) nocons se 3aster rdec(2) comma bracket append;
...
outreg treat using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\Table9C_post.csv", bdec(2) nocons se 3aster rdec(2) comma bracket replace;

regress z_add_post_lang treat pre_lang_v pre_lang_w if pre_writ==0, cluster(schid);
outreg treat using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\Table9C_post.csv", bdec(2) nocons se 3aster rdec(2) comma bracket append;
...
outreg treat using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\Table9D_post.csv", bdec(2) nocons se 3aster rdec(2) comma bracket replace;

regress z_add_post_lang treat pre_lang_v pre_lang_w if pre_writ==1, cluster(schid);
outreg treat using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\Table9D_post.csv", bdec(2) nocons se 3aster rdec(2) comma bracket append;
