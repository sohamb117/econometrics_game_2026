...
log using "C:\Incentives_Matter_Data\Incentives_FINAL\Log Files\Table_11_Post.log", replace;
...
**ADDING PAYMENT DATA AND AVERAGE CHECK DATA!;
drop _merge;
sort schid;
merge schid using "C:\Incentives_Matter_Data\Incentives_FINAL\Raw Data\Tests\Baseline\av_random_post";
drop _merge;

sort schid;
merge schid using "C:\Incentives_Matter_Data\Incentives_FINAL\Raw Data\Tests\Baseline\av_payments_post";
...
**COL 1;
regress post_writ open pre_total_v pre_total_w pre_writ if treat==0, cluster(schid);
outreg open using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\Table11_post.csv", bdec(2) nocons se 3aster rdec(2) comma bracket replace;

regress z_add_post_total open pre_total_v pre_total_w pre_writ if treat==0, cluster(schid);
outreg open using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\Table11_post.csv", bdec(2) nocons se 3aster rdec(2) comma bracket append;


**COL 2;
regress post_writ open pre_total_v pre_total_w pre_writ if treat==1, cluster(schid);
outreg open using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\Table11_post.csv", bdec(2) nocons se 3aster rdec(2) comma bracket append;

regress z_add_post_total open pre_total_v pre_total_w pre_writ if treat==1, cluster(schid);
outreg open using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\Table11_post.csv", bdec(2) nocons se 3aster rdec(2) comma bracket append;
...
replace payment=0 if treat==0;
gen treat_pay=treat*payment;


**COL 3;
gen days=pay/50;
replace days=days/27;

regress post_writ days pre_total_v pre_total_w pre_writ if treat==1, cluster(schid);
outreg days using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\Table11_post.csv", bdec(2) nocons se 3aster rdec(2) comma bracket append;

regress z_add_post_total days pre_total_v pre_total_w pre_writ if treat==1, cluster(schid);
outreg days using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\Table11_post.csv", bdec(2) nocons se 3aster rdec(2) comma bracket append;
