...
capture log close;
log using "C:\Incentives_Matter_Data\Incentives_FINAL\Log Files\Table9_Mid BEF.log", replace;
...
outreg treat using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\Table9B_mid.csv", bdec(2) nocons se 3aster rdec(2) comma bracket replace;

regress z_add_mid_math treat pre_math_v pre_math_w pre_writ block score infra, cluster(schid);
outreg treat using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\Table9B_mid.csv", bdec(2) nocons se 3aster rdec(2) comma bracket append;
...
outreg treat using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\Table9F_mid.csv", bdec(2) nocons se 3aster rdec(2) comma bracket replace;

regress z_add_mid_math treat pre_math_v pre_math_w pre_writ, cluster(schid);
outreg treat using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\Table9F_mid.csv", bdec(2) nocons se 3aster rdec(2) comma bracket append;
...
regress mid_writ treat pre_math_v pre_math_w pre_writ, cluster(schid);
outreg treat using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\Table9E_mid.csv", bdec(2) nocons se 3aster rdec(2) comma bracket replace;

regress z_add_mid_math treat pre_math_v pre_math_w pre_writ, cluster(schid);
outreg treat using "C:\Incentives_Matter_Data\Incentives_FINAL\Output\Table9E_mid.csv", bdec(2) nocons se 3aster rdec(2) comma bracket append;
